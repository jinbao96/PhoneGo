...
<body>
	...
	<div class="container">
		<ul class="pagination">
			<li><a href="parent?pageNum=${page.pageNum-1}&category_id=${category_id}">上一页</a></li>
			<c:forEach begin="1" end="${page.allPage}" var="pg">
				<li class="l${pg}"><a href="parent?pageNum=${pg}&category_id=${category_id}">${pg}</a></li>
			</c:forEach>
			<li><a href="parent?pageNum=${page.pageNum+1}&category_id=${category_id}">下一页</a></li>
			<li>
