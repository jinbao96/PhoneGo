...
<body>
	...
	<div class="header">
		<div class="ht">
			<div class="login">
				...
				<ul class="right">
					<li><img src="<%=request.getContextPath()%>/img/other/icon_3.png"><a href="<%=request.getContextPath()%>/cart?user_id=${sessionScope.user.user_id}">购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;</li>
					<li><img alt="留言" src="<%=request.getContextPath()%>/img/other/icon_2.png"><a href="<%=request.getContextPath()%>/viewmessage">留言</a>&nbsp;&nbsp;&nbsp;&nbsp;</li>
					<li><img alt="首页" src="<%=request.getContextPath()%>/img/other/icon_1.png"><a href="<%=request.getContextPath()%>/goodsPage">首页</a></li>
				</ul>
			</div>
		</div>
		<div class="hm">
	...
	<ul class="product">
		<c:forEach items="${gnamelist}" var="goods">
		<li class="goods">
			<dl>
	...
	<div class="container">
		<ul class="pagination">
			<li><a href="dim?pageNum=${gpage.pageNum-1}&gname=${gname}">上一页</a></li>
			<c:forEach begin="1" end="${gpage.allPage}" var="pg">
				<li class="l${pg}"><a href="dim?pageNum=${pg}&gname=${gname}">${pg}</a></li>
			</c:forEach>
			<li><a href="dim?pageNum=${gpage.pageNum+1}&gname=${gname}">下一页</a></li>
			<li>
				<form action="dim" style="float: left">
